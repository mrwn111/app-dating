...
class User(UserMixin, db.Model):
    ...
    # Relations
    likes_sent = db.relationship('Like', foreign_keys='Like.user_id', backref='liker', lazy=True, cascade='all, delete-orphan')
    likes_received = db.relationship('Like', foreign_keys='Like.liked_user_id', backref='liked_by', lazy=True)
    
    matches = db.relationship('Match', foreign_keys='Match.user_1_id', backref='user_1', lazy=True, cascade='all, delete-orphan')
    matched_with = db.relationship('Match', foreign_keys='Match.user_2_id', backref='user_2', lazy=True)
